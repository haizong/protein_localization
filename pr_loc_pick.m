function obj_chosen = pr_loc_pick(spd_data, str_title, file_name, y_lim, NUM_BIN)
...
for i = 1:length(list_input);
    idx = pr_loc_find_ID(spd_data, list_input(i));
...
[~, ratio_box_mean, ratio_box_std, ratio_line_mean, ratio_line_std] = pr_loc_plot_ratio(spd_data, list_chosen, y_lim, NUM_BIN, str_title, file_name, './');
...
pr_loc_display(spd_data, list_chosen);
